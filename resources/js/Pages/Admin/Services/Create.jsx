                ...
                <div className="mx-auto max-w-4xl sm:px-6 lg:px-8">
                    <form onSubmit={submit} className="bg-white shadow-xl sm:rounded-3xl border border-navy/5 overflow-hidden">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            placeholder="Contoh: Sewa Bus Pariwisata"
                                        />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Jelaskan apa saja yang didapat dari layanan ini..."
                                    />
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        placeholder="Contoh: Unit Terbaru 2024"
                                    />
                                    <button
                                        type="button"
                                        onClick={addFeature}
                        ...
                        <div className="bg-navy/5 p-8 flex justify-between items-center">
                            <p className="text-sm text-navy/40 italic">Layanan akan langsung tampil di landing page setelah disimpan.</p>
                            <button
                                type="submit"
                                disabled={processing}
