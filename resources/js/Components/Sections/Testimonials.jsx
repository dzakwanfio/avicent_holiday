  ...
  const testimonials = [
    {
      ...
      content: "Pelayanan Avicent Holiday sangat memuaskan. Bus JB5-nya sangat nyaman, bersih, dan drivernya sangat profesional. Acara outing kantor kami sukses besar!",
      image: "https://picsum.photos/seed/user1/100/100"
    },
    {
      name: "Siti Aminah",
      role: "Ketua Komite Sekolah",
      content: "Terima kasih Avicent Holiday atas kerjasamanya dalam study tour sekolah kami. Anak-anak merasa aman dan nyaman selama perjalanan.",
      image: "https://picsum.photos/seed/user2/100/100"
    },
    {
      name: "Andi Wijaya",
      role: "Traveler",
      content: "Paket wisata Balinya sangat terencana. Hotelnya bagus, makanannya enak, dan pemandunya sangat ramah. Sangat direkomendasikan!",
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-4">
                <img src={testimonial.image} alt={testimonial.name} className="w-12 h-12 rounded-full object-cover border-2 border-gold/20" referrerPolicy="no-referrer" />
                <div>
                  <h4 className="text-sm font-bold text-navy">{testimonial.name}</h4>
